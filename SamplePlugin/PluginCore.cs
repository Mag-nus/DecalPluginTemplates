...
namespace SamplePlugin
{
	...
	[FriendlyName("SamplePlugin"), View("SamplePlugin.mainView.xml")]
	public class PluginCore : PluginBase
	{
		...
		[ControlEvent("UseSelectedItem", "Click")]
		void UseSelectedItem_Click(object sender, ControlEventArgs e)
		{
			try
			{
		...
		[ControlEvent("ToggleAttack", "Click")]
		void ToggleAttack_Click(object sender, ControlEventArgs e)
		{
			try
			{
		...
		[ControlEvent("DoesNothing", "Click")]
		void DoesNothing_Click(object sender, ControlEventArgs e)
		{
			try
			{
		...
		[ControlReference("SampleList")]
		private ListWrapper SampleList = null;
		...
		[ControlReference("SampleListText")]
		private StaticWrapper SampleListText = null;

		[ControlReference("SampleListCheckBox")]
		private CheckBoxWrapper SampleListCheckBox = null;

		[ControlEvent("SampleListCheckBox", "Change")]
